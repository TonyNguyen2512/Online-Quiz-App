                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container">
                            ...
                            <form action="ClassCreateController" method="POST">
                                <div class="mb-3">
                                    <label for="numberOfStudent" class="form-label">Number of Student</label>
                                    <input type="text" name="numberOfStudent" class="form-control" id="numberOfStudent">
                                </div>
                                <div class="mb-3 form-check">
                                    <input name="status" type="checkbox" class="form-check-input" id="active">
                                    <label class="form-check-label" for="status">Active</label>
                                </div>
                                <input type="hidden" name="check" value="lop" class="form-check-input" id="check">
