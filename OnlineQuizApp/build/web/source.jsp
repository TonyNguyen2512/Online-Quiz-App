            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800" >Source Management</h1>
                        ...
                        <c:if test="${not empty param.search}">
                            <form class="row g-3" action="SourceSearchController">
                                <div class="col-auto">
                        ...
                        <c:if test="${requestScope.LIST_SOURCE != null && not empty requestScope.LIST_SOURCE}">                       
                            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach var="question" varStatus="counter" items="${requestScope.LIST_SOURCE}">
                                        <tr>
                                            <td>${counter.count}</td>
                                            <td>${question.sourceID}</td>
                                            <td>${question.lectureID}</td>
                                            <td>${question.fileDoc}</td>
                                            <td>${question.filePic}</td>
                                            <td>${question.fileVid}</td>
                                            <td>${question.reference}</td>
                                            <td>${question.status}</td>
                                            <td>
                                                <form action="SourceDeleteController">
                                            ...
                                            <td>
                                                <form action="SourceUpdateController">
                                                    ...
                                                    <input type="hidden" name="fileDoc" value="${question.fileDoc}"/>
                                                    <input type="hidden" name="filePic" value="${question.filePic}"/>
                                                    <input type="hidden" name="fileVid" value="${question.fileVid}"/>
                                                    <input type="hidden" name="reference" value="${question.reference}"/>
                                                    <input type="hidden" name="status" value="${question.status}"/>
                                                    <input type="hidden" name="search" value="${param.search}"/>
