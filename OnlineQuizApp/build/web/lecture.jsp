            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800" >Lecture Management</h1>
                        ...
                        <c:if test="${not empty param.search}">
                            <form class="row g-3" action="LectureSearchController">
                                <div class="col-auto">
                        ...
                        <c:if test="${requestScope.LIST_LECTURE != null && not empty requestScope.LIST_LECTURE}">                       
                            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach var="question" varStatus="counter" items="${requestScope.LIST_LECTURE}">
                                        <tr>
                                            <td>${counter.count}</td>
                                            ...
                                            <td>
                                                <form action="LectureDeleteController">
